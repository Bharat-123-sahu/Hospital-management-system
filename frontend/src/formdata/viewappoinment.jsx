...
export default function ViewAppointment() {
  ...
  useEffect(() => {
    // In a real app, fetch doctors and appointments from server
  }, []);
            ...
            <Grid container spacing={2}>
              {appointments.map((a) => (
                <Grid key={a.id} item xs={12}>
                  <Card sx={{ p: 2 }}>
                    <Typography variant="subtitle1">Doctor: {a.doctorName}</Typography>
                    <Typography variant="body2">Patient: {a.patientName}</Typography>
                    <Typography variant="body2">Phone: {a.phone}</Typography>
                    <Typography variant="body2">Date: {a.date}</Typography>
                    <Typography variant="body2">Slot: {a.slot}</Typography>
                  </Card>
                </Grid>
              ))}
            </Grid>
